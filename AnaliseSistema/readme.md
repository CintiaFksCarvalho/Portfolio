...
👉 [Ver diagramas](./Atividade-2-Diagrama-de-classes.pdf)
...
👉 [Ver diagramas](./Atividade-3-Diagramas-de-atividades.pdf)
...
👉 [Ver diagramas](./Atividade-4-Diagramas-de-sequencia.pdf)

---

**Competências demonstradas:** UML 2.0 completo (casos de uso, classes, atividades, sequência). Modelação de sistemas reais para análise de requisitos em TI.
